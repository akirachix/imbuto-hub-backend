...
class MilkRecord(models.Model):
    ...
    official_id = models.ForeignKey('cooperativeOfficials.CooperativeOfficial',on_delete=models.CASCADE, related_name='cooperative_official')  # Optional: use FK if coop table exists
